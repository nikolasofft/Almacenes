...
public class TablaDeGastos extends javax.swing.JInternalFrame {
    ...
    void codigo_busqueda_estado(String texto) {
        String[] colum = {"id", "fecha", "numero_factura", "Proveedor", "Estado", "Montó"};
        String filtro = "" + texto + "_%";
        String sql = "SELECT * FROM com_gasto WHERE estado LIKE " + '"' + filtro + '"';
        ...
        try {
            ...
            while (rs.next()) {
                ...
                fila[1] = rs.getObject("fecha");
                fila[2] = rs.getObject("num_sucursal");
                fila[3] = rs.getObject("proveedor");
                fila[4] = rs.getObject("estado");
                fila[1] = rs.getObject("monto");
    ...
    void codigo_busqueda_proveedor(String texto) {
        String[] colum = {"id", "fecha", "numero_factura", "Proveedor", "Estado", "Montó"};
        String filtro = "" + texto + "_%";
        String sql = "SELECT * FROM com_gasto WHERE proveedor LIKE " + '"' + filtro + '"';
    ...
    void codigo_busqueda_numeroFactura(String texto) {
        String[] colum = {"id", "fecha", "numero_factura", "Proveedor", "Estado", "Montó"};
        String filtro = "" + texto + "_%";
        String sql = "SELECT * FROM com_gasto WHERE numero LIKE " + '"' + filtro + '"';
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_buscador, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 110, -1));
        ...
        getContentPane().add(modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 60, 75, -1));
        ...
        fecha.setText("Fecha");
        getContentPane().add(fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, -1, -1));

        grupoBotones.add(estado);
        estado.setText("Estado");
        getContentPane().add(estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, -1, -1));

        grupoBotones.add(proveedor);
        proveedor.setText("Proveedor");
        getContentPane().add(proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, -1, -1));

        grupoBotones.add(numerodefactura);
        numerodefactura.setText("Numero de factura");
        getContentPane().add(numerodefactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, -1, -1));

        eliminar.setText("Eliminar");
        getContentPane().add(eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 90, 75, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 540, 60, -1));
